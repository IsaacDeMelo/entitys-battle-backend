...
async function fixLegacyUsers() {
    try {
        ...
        for (let u of users) {
            // Corrige estrutura antiga de defeatedNPCs (Array de strings -> Array de objetos)
...
// --- ROTA DE BATALHA ONLINE (O PULO DO GATO ESTAVA AQUI) ---
...
// --- ROTA DE RENDERIZAÇÃO DA BATALHA ---
